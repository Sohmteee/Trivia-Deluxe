    ...
    streaks = [
      {
        ...
        "streaks": [
          ...
          },
          {
            ...
            "progress": permanentLevelStreak >= 20 ? 20 : levelStreak >= 20 ? 20 : levelStreak,
            "limit": 20,
          },
          {
            "title": "Masterful Streak",
            ...
            "progress": permanentLevelStreak >= 50 ? 50 : levelStreak >= 50 ? 50 : levelStreak,
            "limit": 50,
          },
          {
            "title": "Unstoppable Champion",
            ...
            "progress": permanentLevelStreak >= 100 ? 100 : levelStreak >= 100 ? 100 : levelStreak,
            "limit": 100,
          },
        ],
      },
        ...
        "streaks": [
          {
            ...
            "progress": permanentCoinStreak >= 50 ? 50 : coinStreak >= 50 ? 50 : coinStreak,
            "limit": 50,
          },
          {
            "title": "Coin Hoarder",
            ...
            "progress": permanentCoinStreak >= 100 ? 100 : coinStreak >= 100 ? 100 : coinStreak,
            "limit": 100,
          },
          {
            "title": "Gold Gatherer",
            ...
            "progress": permanentCoinStreak >= 200 ? 200 : coinStreak >= 200 ? 200 : coinStreak,
            "limit": 200,
          },
          {
            "title": "Treasure Hunter",
            ...
            "progress": permanentCoinStreak >= 500 ? 500 : coinStreak >= 500 ? 500 : coinStreak,
            "limit": 500,
          },
          {
            "title": "Coin Millionaire",
            ...
            "progress": permanentCoinStreak >= 1000 ? 1000 : coinStreak >= 1000 ? 1000 : coinStreak,
            "limit": 1000,
          },
        ],
      },
        ...
        "streaks": [
          {
            ...
            "progress": permanentTriviaStreak >= 5 ? 5 : triviaStreak >= 5 ? 5 : triviaStreak,
            "limit": 5,
          },
          {
            "title": "Trivia Expert",
            ...
            "progress": permanentTriviaStreak >= 10 ? 10 : triviaStreak >= 10 ? 10 : triviaStreak,
            "limit": 10,
          },
          {
            "title": "Brainiac",
            ...
            "progress": permanentTriviaStreak >= 20 ? 20 : triviaStreak >= 20 ? 20 : triviaStreak,
            "limit": 20,
          },
          {
            "title": "Trivia Grandmaster",
            ...
            "progress": permanentTriviaStreak >= 50 ? 50 : triviaStreak >= 50 ? 50 : triviaStreak,
            "limit": 50,
          },
          {
            "title": "Trivia Maestro",
            ...
            "progress": permanentTriviaStreak >= 100 ? 100 : triviaStreak >= 100 ? 100 : triviaStreak,
            "limit": 100,
          },
        ],
      },
