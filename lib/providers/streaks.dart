...
class StreaksProvider extends ChangeNotifier {
  ...
  int levelStreak = 0, permanentLevelStreak = 0;
  int coinStreak = 0, permanentCoinStreak = 0;
  int triviaStreak = 0, permanentTriviaStreak = 0;
  int leaderboardStreak = 0, permanentLeaderboardStreak = 0;
  int ultimateStreak = 0;
